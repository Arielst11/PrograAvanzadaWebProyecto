...
namespace Entities.Migrations
{
    ...
    [Migration("20240819002255_CorregidoUsuarios")]
    partial class CorregidoUsuarios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Entities.Asistencia", b =>
                {
                    ...
                    b.Property<bool?>("AsistenciaUsuario")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("PorcentajeAsistencia")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Entities.Clase", b =>
                {
            ...
            modelBuilder.Entity("Entities.Entities.Nota", b =>
                {
                    ...
                    b.HasIndex("IdTareaNavigationIdTarea");
            ...
            modelBuilder.Entity("Entities.Entities.Usuario", b =>
                {
                    ...
                    b.HasIndex("IdClaseNavigationIdClase");
            ...
            modelBuilder.Entity("Entities.Entities.Nota", b =>
                {
                    b.HasOne("Entities.Entities.Tarea", "IdTareaNavigation")
                        .WithMany("Nota")
                        .HasForeignKey("IdTareaNavigationIdTarea");
            ...
            modelBuilder.Entity("Entities.Entities.Usuario", b =>
                {
                    b.HasOne("Entities.Entities.Clase", "IdClaseNavigation")
                        .WithMany("Usuarios")
                        .HasForeignKey("IdClaseNavigationIdClase");
