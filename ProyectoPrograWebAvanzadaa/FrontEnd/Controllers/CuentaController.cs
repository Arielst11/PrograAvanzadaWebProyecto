...
namespace FrontEnd.Controllers
{
    public class CuentaController : Controller
    {
        ...
        public CuentaController(ISecurityHelper securityHelper)
        {
        ...
        public IActionResult Login(string ReturneUrl = "/")
        {
            ...
            UsuarioLoginViewModel user = new UsuarioLoginViewModel();
        ...
        [HttpPost]
        public async Task<IActionResult> Login(UsuarioLoginViewModel user)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (!EsValido)
                    {
                        ViewBag.Message = "Credenciales Invalidos";
                        return View(user);
                    }
